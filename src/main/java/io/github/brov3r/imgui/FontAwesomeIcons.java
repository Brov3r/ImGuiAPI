...
public class FontAwesomeIcons {
    /**
     * Minimum value of the FontAwesome icon range.
     */
    public static final short _IconRangeMin = (short) 0xe005;

    /**
     * Maximum value of the FontAwesome icon range.
     */
    public static final short _IconRangeMax = (short) 0xf8ff;

    /**
     * Array containing the range of FontAwesome icons.
     * The first element is the minimum value,
     * the second element is the maximum value,
     * and the third element is reserved (currently set to 0).
     */
